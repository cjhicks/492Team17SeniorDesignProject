...
handles.presenter.SelectDatasetFile();
...
if isnan(epochStart)
    errordlg('Epoch Start must be a number','Error');
else
   handles.presenter.SetEpochStart(epochStart);
end
...
if isnan(epochEnd)
    errordlg('Epoch End must be a number','Error');
else
   handles.presenter.SetEpochEnd(epochEnd);
end
...
handles.presenter.AddElectrode(selected); % call presenter
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.presenter.RunParallelAnalysis();
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.presenter.RunScreePlot();
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.presenter.RunSPCA();


% --- Executes on button press in AddAllBtn.
function AddAllBtn_Callback(hObject, eventdata, handles)
% hObject    handle to AddAllBtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
