...
function []=PCA_MUA_3x2(PCAresults,F3lab,F3Clab,F2lab,F2Clab,varargin)
...
%       F2_1-F3_3
%       F2_2-F3_3
%PCA_MUA_3x2(STPCAresults,'Winner',{'Dealer','Bust','Player'},'Bet',{'large','small'});
...
temp=reshape(PCAresults.Spatial.PmxScr',8,length(PCAresults.time),size(PCAresults.Spatial.PmxScr,1)/length(PCAresults.time));
PCAScoreMeans=[];
for cond=1:Nconds
    for component=1:Ncomps
